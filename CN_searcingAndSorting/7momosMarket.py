...
def momosMarket(arr,amount):
    ...
    if ans==0 and amount<arr[0]:
        return ans,amount
    return ans+1,amount-arr[ans]
...
resArr=modifiedArray([3, 3 ,2,8,5, 8])
print(resArr)
x,y=momosMarket(resArr,4)
print(x,y)
x,y=momosMarket(resArr,2)
print(x,y)
x,y=momosMarket(resArr,25)
print(x,y)
x,y=momosMarket(resArr,17)
print(x,y)
...
#     x,y=momosMarket(newArray,amountSheHas)
#     print(x,y)
